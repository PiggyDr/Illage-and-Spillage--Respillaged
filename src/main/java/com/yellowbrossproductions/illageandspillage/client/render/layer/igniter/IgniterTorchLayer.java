...
@OnlyIn(Dist.CLIENT)
public class IgniterTorchLayer<T extends LivingEntity> extends EyesLayer<T, IgniterModel<T>> {
    ...
    public IgniterTorchLayer(RenderLayerParent<T, IgniterModel<T>> p_i226039_1_) {
        super(p_i226039_1_);
    }
