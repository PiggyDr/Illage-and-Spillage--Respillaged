...
public class ParticlePacket {
    ...
    public ParticlePacket(FriendlyByteBuf buf) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            this.queuedParticles.add(new QueuedParticle(this.readParticle(type, buf), buf.readBoolean(), buf.readDouble(), buf.readDouble(), buf.readDouble(), buf.readDouble(), buf.readDouble(), buf.readDouble()));
        }
